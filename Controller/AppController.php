...
class AppController extends Controller
{
    ...
    public function listPostsAction(Request $request) {
        return $this->render("AppBundle:News:list_posts.html.twig", array(
    ...
    public function showPostAction(Request $request, $slug) {
        return $this->render("AppBundle:News:show_post.html.twig", array(
    ...
    public function listCategoriesAction(Request $request) {
        return $this->render("AppBundle:News:list_categories.html.twig", [
    ...
    public function showCategoryAction(Request $request, Category $category) {
        return $this->render("AppBundle:News:show_category.html.twig", array(
            'category' => $category,
    ...
    public function listArchivesAction(Request $request) {
        return $this->render("AppBundle:News:list_archives.html.twig", [
    ...
    public function showArchiveAction(Request $request, Archive $archive) {
        return $this->render("AppBundle:News:show_archive.html.twig", array(
            'archive' => $archive,
    ...
    public function listCommentsAction(Request $request, Post $post) {
        ...
        return $this->render("AppBundle:News:list_comments.html.twig", array('comments' => $comments));
    }
    ...
    public function createCommentAction(Request $request, Post $post) {
        ...
        return $this->redirectToRoute('app_news_post_show', ['id' => $post->getId()]);
    }
    ...
    public function updateCommentAction(Request $request, Comment $comment) {
        ...
        return $this->redirectToRoute('app_news_post_show', ['id' => $comment->getPost()->getId()]);
    }
    ...
    public function deleteCommentVoteAction(Request $request, Comment $comment) {
        ...
        return $this->redirectToRoute('app_news_post_show', ['id' => $postId]);
    }
}
